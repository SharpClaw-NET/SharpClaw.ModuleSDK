        ...
        string assemblyPath)
    {
        ...
        if (!string.IsNullOrWhiteSpace(runtimeInfo.ModuleType))
        {
            var explicitType = moduleTypes.SingleOrDefault(type =>
                string.Equals(type.FullName, runtimeInfo.ModuleType, StringComparison.Ordinal)
                || string.Equals(type.AssemblyQualifiedName, runtimeInfo.ModuleType, StringComparison.Ordinal)
                || string.Equals(type.Name, runtimeInfo.ModuleType, StringComparison.Ordinal));
        ...
        return matches.Length switch
        {
            ...
            _ => throw new InvalidOperationException(
                ...
                + $"declares module id '{manifest.Id}'. Add moduleType to module.json."),
        };
    }
