...
internal sealed partial class OutOfProcessModuleCapabilityConnection
{
        ...
        IAsyncDisposable
    {
        ...
        private readonly Channel<WebSocketMessage> _hostMessages;
            ...
            int capacity)
        {
            _owner = owner;
            _lease = lease;
            _hostMessages = Channel.CreateBounded<WebSocketMessage>(
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (!message.IsWellFormed || message.Type == WebSocketMessageType.Close)
                throw new OutOfProcessCapabilityException(
            ...
            CancellationToken cancellationToken)
        {
            ...
            lock (_sync)
            {
                ...
                _moduleClosed = message.Type == WebSocketMessageType.Close;
