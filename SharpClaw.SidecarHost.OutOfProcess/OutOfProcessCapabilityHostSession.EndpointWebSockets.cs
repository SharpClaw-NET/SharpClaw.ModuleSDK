...
internal sealed partial class OutOfProcessCapabilityHostSession
{
    ...
    internal sealed class EndpointWebSocketBridge : IAsyncDisposable
    {
        ...
        private readonly Channel<WebSocketMessage> _moduleMessages;
            ...
            CancellationToken cancellationToken)
        {
            ...
            _lease = lease;
            _channel = channel;
            _moduleMessages = Channel.CreateBounded<WebSocketMessage>(
        ...
        internal void AcceptModuleMessage(OutOfProcessEndpointWebSocketMessage frame)
        {
            ...
            lock (_sync)
            {
                ...
                _moduleClosed = frame.Message.Type == WebSocketMessageType.Close;
