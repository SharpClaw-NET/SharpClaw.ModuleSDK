...
public static class SidecarDiscoveryFactory
{
        ...
        DateTimeOffset deadline)
    {
        ...
        return CreateCompiledGraph(graph, protocolVersion, sequence, deadline);
    }

    /// <summary>Creates one measured discovery message for a compiled host graph.</summary>
    public static SidecarDiscoveryEnvelope CreateCompiledGraph(
        ModuleContributionGraph graph,
        int protocolVersion,
        long sequence,
        DateTimeOffset deadline)
    ...
    internal static SidecarDiscoveryEnvelope CreateEnvelope(
        ModuleContributionGraph graph,
